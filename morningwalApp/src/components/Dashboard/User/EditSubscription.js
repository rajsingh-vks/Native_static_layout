...
const EditSubscription = ({route, navigation}) => {
  ...
  const [fields, setFields] = useState({
    subscription_type: route?.params?.data?.subscription?.type || 'Daily',
  ...
  return (
    <View style={[styles.container]}>
      <Header title="Edit Subscription" type='back' rightIcon='true' />
        ...
        <ScrollView
          ...
          <View style={[styles.sectionWrapper, {paddingTop:0, paddingHorizontal:20}]}>
            <Input
              ...
              required={true}
              value={fields.subscription_type}
              data={[
                {Daily: 'Daily'},
                {Alternate: 'Alternate'},
                {Weekly: 'Weekly'},
              ]}
              onChange={val => handleFields({subscription_type: val})}
            />
          </View>
          ...
          <View style={[styles.sectionWrapper, {paddingTop:0, paddingHorizontal:20}]}>
            <Input
              ...
              autoCapitalize="none"
              onChange={val => handleFields({start_date: val})}
              iconName='calendar'
            />
          </View>
